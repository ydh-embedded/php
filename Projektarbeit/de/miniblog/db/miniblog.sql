...
--
-- Host: 127.0.0.1
-- Erstellungszeit: 10. Jan 2024 um 11:54
...
CREATE TABLE `tbl_categories` (
  ...
  `categ_view_count` int(11) NOT NULL COMMENT 'Aufrufe',
  `categ_post_count` int(11) NOT NULL COMMENT 'Antworten',
  `categ_lastpost` timestamp NOT NULL DEFAULT current_timestamp() ON UPDATE current_timestamp() COMMENT 'letzter Beitrag'
...
CREATE TABLE `tbl_posts` (
  ...
  `posts_updated_at` timestamp NULL DEFAULT current_timestamp() ON UPDATE current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
CREATE TABLE `tbl_users` (
  ...
  `users_create` timestamp NULL DEFAULT current_timestamp()
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
